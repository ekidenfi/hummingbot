...
class EkidenPerpetualAuthTests(TestCase):
    def setUp(self) -> None:
        super().setUp()
        ...
        self.auth = EkidenPerpetualAuth(api_key=self.api_key, api_secret=self.secret_key, use_vault=self.use_vault)
    ...
    @patch(
        "hummingbot.connector.derivative.ekiden_perpetual.ekiden_perpetual_auth.EkidenPerpetualAuth._get_timestamp")
