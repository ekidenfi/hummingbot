...
class EkidenPerpetualAPIOrderBookDataSourceTests(IsolatedAsyncioWrapperTestCase):
    ...
    def setUp(self) -> None:
        ...
        self.connector = EkidenPerpetualDerivative(
            client_config_map,
            ekiden_perpetual_api_key="testkey",
            ekiden_perpetual_api_secret="13e56ca9cceebf1f33065c2c5376ab38570a114bc1b003b60d838f92be9d7930",  # noqa: mock
            use_vault=False,
    ...
    @aioresponses()
    @patch.object(EkidenPerpetualAPIOrderBookDataSource, "_sleep")
    ...
    @patch(
        "hummingbot.connector.derivative.ekiden_perpetual.ekiden_perpetual_api_order_book_data_source."
        "EkidenPerpetualAPIOrderBookDataSource._next_funding_time")
    @aioresponses()
