...
class EkidenPerpetualDerivativeTests(AbstractPerpetualDerivativeTests.PerpetualDerivativeTests):
    ...
    def test_supported_position_modes(self):
        client_config_map = ClientConfigAdapter(ClientConfigMap())
        linear_connector = EkidenPerpetualDerivative(
            client_config_map=client_config_map,
            ekiden_perpetual_api_key=self.api_key,
            ekiden_perpetual_api_secret=self.api_secret,
    ...
    @patch(
        "hummingbot.connector.derivative.ekiden_perpetual.ekiden_perpetual_api_order_book_data_source.EkidenPerpetualAPIOrderBookDataSource._next_funding_time")
